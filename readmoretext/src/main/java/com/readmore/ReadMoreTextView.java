...
import com.readmore.readmoretextview.R;
...
public class ReadMoreTextView extends AppCompatTextView {
  ...
  public ReadMoreTextView(Context context, AttributeSet attrs) {
    ...
    int resourceIdTrimCollapsedText =
        typedArray.getResourceId(R.styleable.ReadMoreTextView_trimCollapsedText,
            R.string.read_more);
    ...
    this.colorClickableText = typedArray.getColor(R.styleable.ReadMoreTextView_colorClickableText,
        ContextCompat.getColor(context, R.color.colorSeeMore));
